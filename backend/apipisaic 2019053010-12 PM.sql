...
# Database: apipisaic
# Generation Time: 2019-05-30 14:12:03 +0000
# ************************************************************
...
CREATE TABLE `group_kind_unit_zones` (
  `kind_unit_zone_id` varchar(100) DEFAULT NULL,
...
CREATE TABLE `kind_unit_zones` (
  `kind_unit_id` varchar(100) DEFAULT NULL,
  `zone_id` varchar(100) DEFAULT NULL,
  `id` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `kind_units` (
  `kind_id` varchar(100) DEFAULT NULL,
  `unit_user_id` varchar(100) DEFAULT NULL,
  `id` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
